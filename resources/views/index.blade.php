...
@section('content')
    <main>
      ...
      <section class="card-row-container">
        ...
        <div class="card card-group">
          ...
          <div class="grid-images">
            <div class="image-box">
              <img
                src="{{asset("assets/img/home essentials/home_essentials_1.jpg")}}"
                alt="Dress"
              />
              <span>Dresses</span>
            </div>
            ...
            <div class="image-box">
              <img
                src="{{asset("assets/img/home essentials/home_essentials_3.jpg")}}"
                alt="Jacket"
              />
              <span>Jackets</span>
            </div>
            <div class="image-box">
              <img
                src="{{asset("assets/img/home essentials/home_essentials_4.jpg")}}"
                alt="Jewelry"
              />
              <span>Jewelry</span>
            </div>
        ...
        <div class="carousel-wrapper">
          ...
          <div class="carousel" id="carousel1">
            ...
            <div class="product-card">
              <img
                src="{{asset("assets/img/carsoul-products/carsoul_image_1.jpg")}}"
                alt="Paw Patrol World"
                class="product-image"
              />
            ...
            <div class="product-card">
              <img
                src="{{asset("assets/img/carsoul-products/carsoul_image_1.jpg")}}"
                alt="PAW Patrol Mission Impawsible"
                class="product-image"
              />
              <div class="product-title">
      ...
      <div class="recommendation-section">
        ...
        <span class="new-customer"
          >New customer? <a class="start-here" href="#">Start here.</a></span
        >
      </div>
    </main>
@endsection
